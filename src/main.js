...
// /* parallax */
// // Losanges
// let l1,l2,l3,l4,l5,l8,l9;
// let tl1,tl2,tl3,tl4,tl5,tl8,tl9;
...
//   //losanges roses
//   l1.style.top = tl1 + y * 0.8 + "px";
//   l2.style.top = tl2 + y * 0.2 + "px";
//   l3.style.top = tl3 + y * 0.2 + "px";
//   l4.style.top = tl4 + y * 0.6 + "px";
//   l5.style.top = tl5 + y * 0.6 + "px";
//   l8.style.top = tl8 + y * -0.24 + "px";
//   l9.style.top = tl9 + y * -0.24 + "px";
