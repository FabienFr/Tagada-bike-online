    ...
    <div class="container mx-auto">
      <div class="grid mx-auto grid-cols-2 md:grid-cols-5">
        ...
        <div
          ...
          <span
            class="text-blue uppercase text-2xl lg:text-4xl 2xl:text-5xl 3xl:text-7xl text-center font-extrabold">électrique</span>
        </div>
        <div
  ...
  <section class="mx-auto overflow-hidden relative mt-20 bg-gradient-to-b from-white via-gray-200 to-white">
    ...
    <div
      ...
      <div
        ...
        <h4 class="text-blue text-lg lg:text-xl 2xl:text-3xl text-center font-bold sm:py-6">Set DJ <br />pour animations
          de qualité</h4>
      ...
      <div
        ...
        <img
          ...
          class="h-12 sm:h-10 xl:h-20 3xl:h-28 mt-2 mb-6" />
        <h4 class="text-pink text-lg lg:text-xl 2xl:text-3xl text-center font-bold sm:py-6">Set environnement <br />pour
